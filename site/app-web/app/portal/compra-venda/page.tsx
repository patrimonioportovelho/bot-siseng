...
// salvo no navegador, se tiver. Negócios finalizados/cancelados saem desta
// lista (mesmo critério de STATUS_TRANSACAO_EM_ABERTO usado no resto do
// sistema) — já contam no painel principal (/portal), não precisam ficar
// aparecendo aqui indefinidamente.
            ...
            {transacoes.map((t) => (
              <div key={t.id} className="bg-white border border-gray-200 rounded-xl p-4">
                ...
                <div className="text-[11px] text-gray-400">
                  {t.id_legado ?? t.id} · {formatMoeda(t.valor_transacao)} · cadastrado em{" "}
